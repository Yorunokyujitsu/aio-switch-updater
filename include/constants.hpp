...
constexpr const char CHANGELOG_URL[] = "https://asadayo.tistory.com/notice/440";

constexpr const char APP_URL[] = "https://github.com/Yorunokyujitsu/archive_aio/releases/latest/download/app.zip";
